...
const TermsAndConditions = () => {
  return (
    <div>
      ...
      <h3>4. Grant of License to You to use Contributions for Personal, Non-Commercial Purposes</h3>
      ...
      <h4>    4.2.1 Retention of IP Notices.</h4>
      <ul>If you download, copy or print a copy of the Materials (as defined in Section 6 below) for your own personal use, you must retain all trademark, copyright and other proprietary notices contained in and on the materials.
      </ul>
      <h4> 4.2.2 No Circumvention of IP Protection Mechanisms.</h4>
      <ul> You shall not either directly or through the use of any device, software, internet site, web-based service or other means remove, alter, bypass, avoid, interfere with, or circumvent any copyright, trademark, or other proprietary notices marked on Contributions or any digital rights management mechanism, device, or other content protection or access control measure associated with Contributions or the Site.
      </ul>

      <h4>4.2.3 No Unauthorized Copying, Broadcasting or Screen Scraping. </h4>
      <ul> You shall not either directly or through the use of any device, software, internet site, web-based service or other means copy, download, reproduce, duplicate, archive, distribute, upload, publish, modify, translate, broadcast, perform, display, sell, transfer, rent, sub-license, transmit or retransmit Contributions except as permitted in Section 4.1.
      </ul>

      <h4> 4.2.4 No Indexing.</h4>
      <ul>Furthermore, you may not create, recreate, distribute or advertise an index of any Contributions unless authorized by us in writing.</ul>

      <h4>4.2.5 No Commercial Use of Contributions.</h4>
      <ul> You may not build a business utilizing the Contributions, whether or not for profit. Contributions covered by these restrictions include without limitation any text, graphics, layout, interface, logos, photographs, audio and video materials, and stills.</ul>

      <h4>4.2.6 No Derivative Works.</h4>
      ...
      <h3>5. Use and Protection of Account Number and Password</h3>
      <Paragraph variant="normal">
      ...
      Copyright Agent at: 2160 Gold Street, San Jose, CA 95002. Email: dmca@themoviedb.org. Phone: 408.519.9100.
      ...
      <h3>10. Non-commercial Use by Users</h3>
      <Paragraph variant="normal">
      ...
      <ul>This Agreement (and our Privacy Policy) constitutes the entire agreement between you and us regarding the use of this Site and Services and supersedes any prior or contemporaneous understandings and agreements between you and us related to the subject matter hereof.
      </ul>

      <h4>17.2 Independent Contractors.</h4>
      <ul>Nothing in this Agreement shall be deemed to create an agency, partnership, joint venture, employer-employee or franchisor-franchisee relationship of any kind between us and any user.

      </ul>


      <h4>17.3 No Third Party Beneficiaries.</h4>
      <ul>This Agreement is between you and us. There are no third-party beneficiaries to this Agreement.</ul>

      <h4>17.4 Section Titles.</h4>
      <ul> The section titles in this Agreement are for convenience only and have no legal or contractual effect.</ul>

      <h4>17.5 Non-Waiver.</h4>
      <ul>Our failure to exercise or enforce any right or provision of this Agreement shall not operate as a waiver of such right or provision.</ul>

      <h4>17.6 Severability. </h4>
      <ul>This Agreement operates to the fullest extent permissible by law. If any provision or part of a provision of this Agreement is unlawful, void, or unenforceable, that provision or part of the provision is deemed severable from this Agreement and shall not affect the validity and enforceability of any remaining provisions.

      </ul>

      <h4>17.7 Assignment.</h4>
      <ul>You may not assign your rights under this Agreement to any third party; we may assign our rights under this Agreement without condition.</ul>

      <h4>17.8 NOTICES.</h4>
      <ul>Any notice to be sent to you under this Agreement may be sent via email, post, or any other reasonable means, at the contact information provided by you to TMDB from time to time. It is your obligation to insure that this information is current. Please send any notices to TiVo Platform Technologies, LLC at 2160 Gold Street, San Jose, CA 95002 and e-mail privacy@tivo.com.

      </ul>


      <ul>This Agreement was last updated on: July 26, 2019.</ul>
